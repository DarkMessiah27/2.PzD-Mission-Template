// This module adds an icon to the D-UI HUD compass for the vehicle assigned to each squad.

// This array assigns vehicles to squads
// Each assignment should consist of an array that contains the variable name of the group, and the variable name of the vehicle.
